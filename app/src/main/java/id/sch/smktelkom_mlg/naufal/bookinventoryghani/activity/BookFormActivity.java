package id.sch.smktelkom_mlg.naufal.bookinventoryghani.activity;
...
import id.sch.smktelkom_mlg.naufal.bookinventoryghani.R;
...
public class BookFormActivity extends AppCompatActivity {
    ...
    @BindView(R.id.editPublishYear) EditText editPublishYear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle != null) {
            book = (Books) bundle.getSerializable("bookEdit");
